...
let arrayData = dataObject.data.components(separatedBy: ",")

var count = 0

//for item in arrayData where item.contains("age=") {
//
//    let value = Int(item.trimmingCharacters(in: .whitespaces).replacingOccurrences(of: "age=", with: "")) ?? 0
//    if value >= 50 {
//        count += 1
//    }
//}
